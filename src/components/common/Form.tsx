...
function Form({ type, register, handleSubmit, onFinishHandler, propertyImage, handleImageChange, formLoading }: FormProps) {
  return (
    <Box>
      ...
      <Box mt={2.5} borderRadius="15px" padding="20px" bgcolor="#fcfcfc" >
        <form style={{ marginTop: '20px', width: '100%', display: 'flex', flexDirection: 'column', gap: '20px' }}
          ...
          color='info'
          style={{width: '100%', background: 'transparent', fontSize:'16px', borderColor:'rgba(0,0,0,0.23)',borderRadius:'6', padding: 10, color: '#919191'}} {...register('description', {required: true})}
           />
          </FormControl>
            ...
            >
                ...
                <MenuItem  value="duplex"> Dublex  </MenuItem>

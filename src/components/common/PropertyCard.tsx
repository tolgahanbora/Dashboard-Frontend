...
function PropertyCard({id,title,price,photo,location}: PropertyCardProps) {
  return (
    <Card
    component={Link}
    ...
    >
      ...
      <CardContent sx={{
        justifyContent: "center", display: "flex", flexDirection: "row", gap:"10px", paddingX: '5px'
      }}>
    ...
    <Stack direction="row" gap={0.5} alignItems="flex-start">
      ...
      />
      <Typography fontSize={14} fontWeight={500} color="#808191">{location}</Typography>
    </Stack>
        </Stack>

...
import { EmailOutlined, LocationCity, Phone,
  Place } from '@mui/icons-material'
...
function AgentCard({id,name,email,avatar,noOfProperties} : AgentCardProp) {
  ...
  return (
   ...
   >
    <img  src={avatar} alt='user' width={90} height={90} style={{borderRadius: 8, objectFit: 'cover', marginRight: "10px" }} />
